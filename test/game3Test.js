...
describe('Game3', function () {
  async function deployContractAndSetVariables() {
    ...
    return { game, signer1,address1,signer2,address2,signer3,address3 };
  }

  it('should be a winner', async function () {
    const { game, signer1,address1,signer2,address2,signer3,address3 } = await loadFixture(deployContractAndSetVariables);
